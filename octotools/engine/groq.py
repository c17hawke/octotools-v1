...
class ChatGroq(EngineLM, CachedEngine):
    ...
    def __init__(
        self,
        model_string="llama-3.2-11b-vision-preview",
    ...
    def generate(self, content: Union[str, List[Union[str, bytes]]], system_prompt=None, **kwargs):
        ...
        # FIXME: Add support for groq related errors
        # except groq.LengthFinishReasonError as e:
    ...
    def _generate_text(
        ...
        elif self.model_string in GROQ_STRUCTURED_MODELS and response_format is not None:
            response = self.client.beta.chat.completions.parse(
                model=self.model_string,
                messages=[
